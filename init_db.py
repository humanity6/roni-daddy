...
def init_phone_models():
    ...
    try:
        iphone_models = [
            {"name": "iPhone 16 Pro Max", "chinese_model_id": "iphone-16-pro-max", "display_order": 1},
            {"name": "iPhone 16 Pro", "chinese_model_id": "iphone-16-pro", "display_order": 2},
            {"name": "iPhone 16 Plus", "chinese_model_id": "iphone-16-plus", "display_order": 3},
            {"name": "iPhone 16", "chinese_model_id": "iphone-16", "display_order": 4},
            {"name": "iPhone 15 Pro Max", "chinese_model_id": "iphone-15-pro-max", "display_order": 5},
            {"name": "iPhone 15 Pro", "chinese_model_id": "iphone-15-pro", "display_order": 6},
            {"name": "iPhone 15 Plus", "chinese_model_id": "iphone-15-plus", "display_order": 7},
            {"name": "iPhone 15", "chinese_model_id": "iphone-15", "display_order": 8},
            {"name": "iPhone 14 Pro Max", "chinese_model_id": "iphone-14-pro-max", "display_order": 9},
            {"name": "iPhone 14 Pro", "chinese_model_id": "iphone-14-pro", "display_order": 10},
            {"name": "iPhone 14 Plus", "chinese_model_id": "iphone-14-plus", "display_order": 11},
            {"name": "iPhone 14", "chinese_model_id": "iphone-14", "display_order": 12},
            {"name": "iPhone 13 Pro Max", "chinese_model_id": "iphone-13-pro-max", "display_order": 13},
            {"name": "iPhone 13 Pro", "chinese_model_id": "iphone-13-pro", "display_order": 14},
            {"name": "iPhone 13", "chinese_model_id": "iphone-13", "display_order": 15},
            {"name": "iPhone 13 mini", "chinese_model_id": "iphone-13-mini", "display_order": 16},
            {"name": "iPhone 12 Pro Max", "chinese_model_id": "iphone-12-pro-max", "display_order": 17},
            {"name": "iPhone 12 Pro", "chinese_model_id": "iphone-12-pro", "display_order": 18},
            {"name": "iPhone 12", "chinese_model_id": "iphone-12", "display_order": 19},
            {"name": "iPhone 12 mini", "chinese_model_id": "iphone-12-mini", "display_order": 20},
        ]

        samsung_models = [
            {"name": "Galaxy S24 Ultra", "chinese_model_id": "galaxy-s24-ultra", "display_order": 1},
            {"name": "Galaxy S24 Plus", "chinese_model_id": "galaxy-s24-plus", "display_order": 2},
            {"name": "Galaxy S24", "chinese_model_id": "galaxy-s24", "display_order": 3},
            {"name": "Galaxy S23 Ultra", "chinese_model_id": "galaxy-s23-ultra", "display_order": 4},
            {"name": "Galaxy S23 Plus", "chinese_model_id": "galaxy-s23-plus", "display_order": 5},
            {"name": "Galaxy S23", "chinese_model_id": "galaxy-s23", "display_order": 6},
            {"name": "Galaxy S22 Ultra", "chinese_model_id": "galaxy-s22-ultra", "display_order": 7},
            {"name": "Galaxy S22 Plus", "chinese_model_id": "galaxy-s22-plus", "display_order": 8},
            {"name": "Galaxy S22", "chinese_model_id": "galaxy-s22", "display_order": 9},
            {"name": "Galaxy S21 Ultra", "chinese_model_id": "galaxy-s21-ultra", "display_order": 10},
            {"name": "Galaxy S21 Plus", "chinese_model_id": "galaxy-s21-plus", "display_order": 11},
            {"name": "Galaxy S21", "chinese_model_id": "galaxy-s21", "display_order": 12},
            {"name": "Galaxy Z Fold 6", "chinese_model_id": "galaxy-z-fold6", "display_order": 13},
            {"name": "Galaxy Z Fold 5", "chinese_model_id": "galaxy-z-fold5", "display_order": 14},
            {"name": "Galaxy Z Fold 4", "chinese_model_id": "galaxy-z-fold4", "display_order": 15},
            {"name": "Galaxy Z Flip 6", "chinese_model_id": "galaxy-z-flip6", "display_order": 16},
            {"name": "Galaxy Z Flip 5", "chinese_model_id": "galaxy-z-flip5", "display_order": 17},
            {"name": "Galaxy Z Flip 4", "chinese_model_id": "galaxy-z-flip4", "display_order": 18},
            {"name": "Galaxy A55", "chinese_model_id": "galaxy-a55", "display_order": 19},
            {"name": "Galaxy A35", "chinese_model_id": "galaxy-a35", "display_order": 20},
            {"name": "Galaxy A25", "chinese_model_id": "galaxy-a25", "display_order": 21},
        ]

        google_models = [
            {"name": "Pixel 9 Pro XL", "chinese_model_id": "pixel-9-pro-xl", "display_order": 1},
            {"name": "Pixel 9 Pro", "chinese_model_id": "pixel-9-pro", "display_order": 2},
            {"name": "Pixel 9", "chinese_model_id": "pixel-9", "display_order": 3},
            {"name": "Pixel 8 Pro", "chinese_model_id": "pixel-8-pro", "display_order": 4},
            {"name": "Pixel 8", "chinese_model_id": "pixel-8", "display_order": 5},
            {"name": "Pixel 8a", "chinese_model_id": "pixel-8a", "display_order": 6},
            {"name": "Pixel 7 Pro", "chinese_model_id": "pixel-7-pro", "display_order": 7},
            {"name": "Pixel 7", "chinese_model_id": "pixel-7", "display_order": 8},
            {"name": "Pixel 7a", "chinese_model_id": "pixel-7a", "display_order": 9},
            {"name": "Pixel 6 Pro", "chinese_model_id": "pixel-6-pro", "display_order": 10},
            {"name": "Pixel 6", "chinese_model_id": "pixel-6", "display_order": 11},
            {"name": "Pixel 6a", "chinese_model_id": "pixel-6a", "display_order": 12},
            {"name": "Pixel 5", "chinese_model_id": "pixel-5", "display_order": 13},
            {"name": "Pixel 5a", "chinese_model_id": "pixel-5a", "display_order": 14},
            {"name": "Pixel 4 XL", "chinese_model_id": "pixel-4-xl", "display_order": 15},
            {"name": "Pixel 4", "chinese_model_id": "pixel-4", "display_order": 16},
            {"name": "Pixel 4a", "chinese_model_id": "pixel-4a", "display_order": 17},
        ]
        ...
        for brand_id, models in all_models:
            for model_data in models:
                model_id = f"{brand_id}-{model_data['chinese_model_id']}"
                ...
                if not existing:
                    phone_model = PhoneModel(
                        ...
                        chinese_model_id=model_data["chinese_model_id"],
                        price=19.99,
                        stock=100,
                        is_available=True,
