        ...
        for item in stock_data:
            if item.get("stock", 0) > 0:  # Only include models with stock
                models.append({
                    ...
                    "is_available": True,
                    # CRITICAL: Include Chinese API dimensions for proper phone case fitting
                    "width": item.get("width"),  # Width in millimeters
                    "height": item.get("height"),  # Height in millimeters
