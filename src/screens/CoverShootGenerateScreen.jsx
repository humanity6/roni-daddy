  ...
  return (
    <div className="screen-container">
      ...
      <div className="relative z-10 flex items-center justify-between p-4">
        ...
        <h1 className="text-lg font-semibold text-gray-800">Cover Shoot</h1>
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6">
        ...
        <div className="flex items-center w-full max-w-xs mb-6 px-2">
          <button className="w-12 h-12 rounded-md bg-white border border-gray-300 flex items-center justify-center shadow-md"><ChevronLeft size={24} className="text-gray-600"/></button>
          ...
          <button className="w-12 h-12 rounded-md bg-white border border-gray-300 flex items-center justify-center shadow-md"><ChevronRight size={24} className="text-gray-600"/></button>
        </div>
      </div>
